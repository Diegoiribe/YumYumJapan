  ...
  return (
    <div className="flex items-center justify-center bg-gray-200 z-50 absolute">
      <div className="fixed bottom-2 right-2 flex flex-col items-center">
        ...
        <div
          className={`flex flex-col items-center mb-2 transition-all duration-500 ${
            isVisible
        ...
        >
          <a
            ...
            className="w-12 h-12 m-1 bg-green-500 rounded-lg bg-center bg-cover"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-12 h-12 m-1 bg-pink-600 rounded-lg bg-center bg-cover"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-12 h-12 m-1 bg-blue-600 rounded-lg bg-center bg-cover"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-12 h-12 m-1 bg-black rounded-lg bg-center bg-cover"
